...
\newcommand{\src}[1]{
  \filename@parse{#1}
  \begin{switch}{\filename@ext}
    \case{hs}{
      \mdfsetup{%
        % frametitle={%
        %   \tikz[baseline=(current bounding box.east),outer sep=0pt]
        %   \node[anchor=east,rectangle,fill=blue!20]
        %   {\includegraphics[height=8pt]{fig/icons/haskell-2.png}};},
        linecolor=blue!20,%
        % innertopmargin=0pt,
        % linewidth=.5pt,
        % topline=true,
      ...
      \begin{mdframed}
        \inputminted[autogobble]{text}{\currfileabsdir#1}
      \end{mdframed}
    }
  \end{switch}

  % based on https://texblog.org/2015/09/30/fancy-boxes-for-theorem-lemma-and-proof-with-mdframed/
  \NoIndentAfterThis
}
\makeatother
